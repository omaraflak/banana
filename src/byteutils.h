...
uint8_t add_byte(const uint8_t& a, const uint8_t& b);
uint16_t add_short(const uint16_t& a, const uint16_t& b);
uint32_t add_int(const uint32_t& a, const uint32_t& b);
uint64_t add_long(const uint64_t& a, const uint64_t& b);

uint8_t sub_byte(const uint8_t& a, const uint8_t& b);
uint16_t sub_short(const uint16_t& a, const uint16_t& b);
uint32_t sub_int(const uint32_t& a, const uint32_t& b);
uint64_t sub_long(const uint64_t& a, const uint64_t& b);

uint8_t mul_byte(const uint8_t& a, const uint8_t& b);
uint16_t mul_short(const uint16_t& a, const uint16_t& b);
uint32_t mul_int(const uint32_t& a, const uint32_t& b);
uint64_t mul_long(const uint64_t& a, const uint64_t& b);

uint8_t div_byte(const uint8_t& a, const uint8_t& b);
uint16_t div_short(const uint16_t& a, const uint16_t& b);
uint32_t div_int(const uint32_t& a, const uint32_t& b);
uint64_t div_long(const uint64_t& a, const uint64_t& b);

uint8_t mod_byte(const uint8_t& a, const uint8_t& b);
uint16_t mod_short(const uint16_t& a, const uint16_t& b);
uint32_t mod_int(const uint32_t& a, const uint32_t& b);
uint64_t mod_long(const uint64_t& a, const uint64_t& b);

uint8_t and_byte(const uint8_t& a, const uint8_t& b);
uint16_t and_short(const uint16_t& a, const uint16_t& b);
uint32_t and_int(const uint32_t& a, const uint32_t& b);
uint64_t and_long(const uint64_t& a, const uint64_t& b);

uint8_t or_byte(const uint8_t& a, const uint8_t& b);
uint16_t or_short(const uint16_t& a, const uint16_t& b);
uint32_t or_int(const uint32_t& a, const uint32_t& b);
uint64_t or_long(const uint64_t& a, const uint64_t& b);

uint8_t xor_byte(const uint8_t& a, const uint8_t& b);
uint16_t xor_short(const uint16_t& a, const uint16_t& b);
uint32_t xor_int(const uint32_t& a, const uint32_t& b);
uint64_t xor_long(const uint64_t& a, const uint64_t& b);

uint64_t not_long(const uint64_t& x);

uint8_t lt_byte(const uint8_t& a, const uint8_t& b);
uint8_t lt_short(const uint16_t& a, const uint16_t& b);
uint8_t lt_int(const uint32_t& a, const uint32_t& b);
uint8_t lt_long(const uint64_t& a, const uint64_t& b);

uint8_t lte_byte(const uint8_t& a, const uint8_t& b);
uint8_t lte_short(const uint16_t& a, const uint16_t& b);
uint8_t lte_int(const uint32_t& a, const uint32_t& b);
uint8_t lte_long(const uint64_t& a, const uint64_t& b);

uint8_t gt_byte(const uint8_t& a, const uint8_t& b);
uint8_t gt_short(const uint16_t& a, const uint16_t& b);
uint8_t gt_int(const uint32_t& a, const uint32_t& b);
uint8_t gt_long(const uint64_t& a, const uint64_t& b);

uint8_t gte_byte(const uint8_t& a, const uint8_t& b);
uint8_t gte_short(const uint16_t& a, const uint16_t& b);
uint8_t gte_int(const uint32_t& a, const uint32_t& b);
uint8_t gte_long(const uint64_t& a, const uint64_t& b);

uint8_t eq_byte(const uint8_t& a, const uint8_t& b);
uint8_t eq_short(const uint16_t& a, const uint16_t& b);
uint8_t eq_int(const uint32_t& a, const uint32_t& b);
uint8_t eq_long(const uint64_t& a, const uint64_t& b);

uint8_t not_eq_byte(const uint8_t& a, const uint8_t& b);
uint8_t not_eq_short(const uint16_t& a, const uint16_t& b);
uint8_t not_eq_int(const uint32_t& a, const uint32_t& b);
